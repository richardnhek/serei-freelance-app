...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryColor = const Color(0xFF8EFFC1);
  late Color tertiaryColor = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFF8EFFC1);
...
class DarkModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFF8EFFC1);
  late Color secondaryColor = const Color(0xFF39D2C0);
  late Color tertiaryColor = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFF8EFFC1);
  late Color primaryBackground = const Color(0xFF01052D);
  late Color secondaryBackground = const Color(0xFF171E6A);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFCCCFD2);
